...
class AnimeControllerTest {
    ...
    void list_ReturnsListOfAnimesInsidePageObject_WhenSuccessuful(){
    ...
    void listAll_ReturnsListOfAnimesInsidePageObject_WhenSuccessuful(){
        String expectedName = AnimeCreator.createValidAnime().getName();
    ...
    void findById_ReturnsAnimesInsidePageObject_WhenSuccessuful(){
    ...
    void findByName_ReturnsAnimes_WhenSuccessuful(){
        String expectedName = AnimeCreator.createValidAnime().getName();
    ...
    void save_ReturnsAnimes_WhenSuccessuful(){
    ...
    void delete_removesAnimes_WhenSuccessuful(){
